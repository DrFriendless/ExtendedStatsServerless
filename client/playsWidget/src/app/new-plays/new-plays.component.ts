...
import { CollectionWithPlays, makeGamesIndex } from "extstats-core";
...
export class NewPlaysComponent extends DataViewComponent<CollectionWithPlays> {
  @ViewChild('target') target: ElementRef;

  protected processData(collection: CollectionWithPlays) {
