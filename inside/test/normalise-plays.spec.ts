...
const ONE_PLAY_OF_GAME = {
    expansions: [], isExpansion: false, quantity: 1, game: 1, geek: 1, date: 1, month: 1, year: 2020
};
const TWO_PLAYS_OF_GAME = {
    expansions: [], isExpansion: false, quantity: 2, game: 1, geek: 1, date: 1, month: 1, year: 2020
};
